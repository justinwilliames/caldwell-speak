...
struct AboutView: View {
    ...
    var body: some View {
        VStack(spacing: 18) {
            ...
            VStack(spacing: 10) {
                Text("Pulsar speaks text aloud — powered by Kokoro, an on-device neural voice, driven by Claude Code hooks. Nothing leaves this Mac. Speaks bespoke lines as Pulsar, end of every turn.")
                    .font(.callout)
